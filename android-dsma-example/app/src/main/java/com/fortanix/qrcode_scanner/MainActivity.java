...
public class MainActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    DSMAccelerator client = new DSMAccelerator("https://sdkms.fortanix.com", null);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(sharedPreferences.getString("fortanix_endpoint", null) == null) {
            ...
            editor.putString("fortanix_endpoint", "https://sdkms.fortanix.com");
            editor.apply();
        }
        ...
        if(sharedPreferences.getString("cache_duration", null) == null) {
            SharedPreferences.Editor editor = sharedPreferences.edit();
            editor.putString("cache_duration", "20");
            editor.apply();
        }
